...
def register():
    ...
    if username_error or password_error or confirm_password_error or access_code_error:
        ...
        register_status_label.config(text="Enregistrement réussi.", foreground="green")
...
register_frame.place(relx=0.5, rely=0.4, anchor=tk.CENTER)
...
register_button = ttk.Button(register_canvas, text="Enregistrer", command=register, image=images[4], compound=tk.LEFT)
register_button.place(relx=0.5, rely=0.75, anchor=tk.CENTER)
